...
//           setMinimumSize(new java.awt.Dimension(1020,720));
	   ...
	   ima.setIcon(new ImageIcon("Images/Regist.jpg"));
	...
	einReg.setForeground(new Color(51,153,255));
                 ...
                 einReg.setToolTipText("Press to Register the Student of M.K.C.G");
	...
	ouReg.setToolTipText("Press to Register the Student of M.k.C.G");
