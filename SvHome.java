...
import javax.swing.*;
 ...
 public class SvHome extends JFrame

      {
	   ...
	   stop=new JLabel("M.K.C.G Medical College , Berhampur");
	  ...
	  label.setIcon(new ImageIcon("cart.gif"));
                                 ...
                                 public SpecialPanel()

                                       {
                                         ...
                                         mts.setForeground(new Color(0,0,255));
 										 ...
 										 mts.setIcon(new ImageIcon("modif.jpg"));
                                          ...
                                          JLabel  mts,mts1,mts2,mts3,uss, ust,uts1,uts2,xray,dw,cd,imm,ann,fas;
                                                        ...
                                                        
					                                  {
                                                          ...
                                                          mts.setForeground(new Color(0,0,255));
 														  ...
 														  mts.setIcon(new ImageIcon("bene2.jpg"));
